...
// Client is the "erabooru" service client.
type Client struct {
	SayHelloEndpoint goa.Endpoint
}

// NewClient initializes a "erabooru" service client given the endpoints.
...
// SayHello calls the "sayHello" endpoint of the "erabooru" service.
