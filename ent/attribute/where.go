...
func HasMediaWith(preds ...predicate.Media) predicate.Attribute {
	return predicate.Attribute(func(s *sql.Selector) {
		step := newMediaStep()
...
func HasMediaAttributes() predicate.Attribute {
	return predicate.Attribute(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasMediaAttributesWith(preds ...predicate.MediaAttribute) predicate.Attribute {
	return predicate.Attribute(func(s *sql.Selector) {
